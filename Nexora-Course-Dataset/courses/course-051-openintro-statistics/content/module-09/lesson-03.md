...
variable smoke is coded 1 if the mother is a smoker, and 0 if 
...
- Is there a statistically significant relationship between the average birth 
weight and smoking?
parts

Baby weights, Part II 
Exercise~ introduces a data set
...
Baby weights, Part III We considered the 
variables smoke and parity, one at a time, in modeling birth 
weights of babies in Exercises~ and~. 
...
of interest include length of pregnancy in days (gestation), mother's 
age in years (age), mother's height in inches (height), and 
mother's pregnancy weight in pounds (weight). Below are three 
observations from this data set. 
center
tabularr c c c c c c c
...
variables.
- Interpret the slopes of gestation and age in this 
context.
- The coefficient for parity is different than in the linear 
model shown in Exercise~. Why might there be a difference?
- Calculate the residual for the first observation in the data set.
- The variance of the residuals is 249.28, and the variance of the birth 
...
Absenteeism, Part I Researchers interested in the 
...
(eth: 0 - aboriginal, 1 - not aboriginal), sex (sex: 0 - 
female, 1 - male), and learner status (lrn: 0 - average learner, 1 - 
slow learner). 
center
tabularrrrrr
...
- The variance of the residuals is 240.57, and the variance of the number of 
...
GPA A survey of 55 Duke University students asked about their 
...
- Would you expect a 95\
variables to include 0? Explain
parts

Cherry trees Timber yield is approximately equal to the 
...
ground), and volume in cubic feet.
table[ht]
center
tabularrrrrr
...
- One tree in this sample is 79 feet tall, has a diameter of 11.3 inches, 
