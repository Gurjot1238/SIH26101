...
> Official URL: https://openstax.org/books/algebra-and-trigonometry/pages/3-7-inverse-functions
> License: CC BY 4.0
...
If some physical machines can run in two directions, we might ask whether some of the function “machines” we have been studying can also run backwards. [Figure 1](<3-7-inverse-functions#Figure_01_07_001>) provides a visual representation of this question. In this section, we will consider the reverse nature of functions.
...
Knowing that a comfortable 75 degrees Fahrenheit is about 24 degrees Celsius, he sends his assistant the week’s weather forecast from [Figure 2](<3-7-inverse-functions#Figure_01_07_002>) for Milan, and asks her to convert all of the temperatures to degrees Fahrenheit.
...
Notice that if we show the coordinate pairs in a table form, the input and output are clearly reversed. See [Table 1](<3-7-inverse-functions#Table_01_07_01>).
...
**Given two functions f(x) f(x) and  g(x), g(x), test whether the functions are inverses of each other.**
  ...
  2. If either statement is true, then both are true, and  g= f −1 g= f −1 and  f= g −1 . f= g −1 . If either statement is false, then both are false, and  g≠ f −1 g≠ f −1 and  f≠ g −1 . f≠ g −1 .
...
The outputs of the function  f f are the inputs to  f −1 , f −1 , so the range of  f f is also the domain of  f −1 . f −1 . Likewise, because the inputs to  f f are the outputs of  f −1 , f −1 , the domain of  f f is the range of  f −1 . f −1 . We can visualize the situation as in [Figure 3](<3-7-inverse-functions#Figure_01_07_003>).
...
Identify which of the toolkit functions besides the quadratic function are not one-to-one, and find a restricted domain on which each function is one-to-one, if any. The toolkit functions are reviewed in [Table 2](<3-7-inverse-functions#Table_01_07_02>). We restrict the domain in such a fashion that the function assumes all _y_ -values exactly once.
...
We can see that these functions (if unrestricted) are not one-to-one by looking at their graphs, shown in [Figure 4](<3-7-inverse-functions#Figure_01_07_004>). They both would fail the horizontal line test. However, if a function is restricted to a certain domain so that it passes the horizontal line test, then in that restricted domain, it can have an inverse.

![Graph of an absolute function.](/apps/image-cdn/v1/f=webp/apps/archive/20260604.144757/resources/00bda7583dbe37e4dd9509bc0c6bfce56021ef7d) Figure  4 (a) Absolute value (b) Reciprocal square
...
A function  f(t) f(t) is given in [Table 3](<3-7-inverse-functions#Table_01_07_03>), showing distance in miles that a car has traveled in  t t minutes. Find and interpret  f −1 (70). f −1 (70).
...
Using [Table 4](<3-7-inverse-functions#Table_01_07_04>), find and interpret ⓐ f(60), f(60), and ⓑ f −1 (60). f −1 (60).
...
A function  g(x) g(x) is given in [Figure 5](<3-7-inverse-functions#Figure_01_07_006>). Find  g(3) g(3) and  g −1 (3). g −1 (3).
...
Using the graph in [Figure 6](<3-7-inverse-functions#Figure_01_07_007>), ⓐ find  g −1 (1), g −1 (1), and ⓑ estimate  g −1 (4). g −1 (4).
...
y = 2 x−3 +4 Set up an equation. y−4 = 2 x−3 Subtract 4 from both sides. x−3 = 2 y−4 Multiply both sides by x−3and divide by y−4. x = 2 y−4 +3 Add 3 to both sides. y = 2 x−3 +4 Set up an equation. y−4 = 2 x−3 Subtract 4 from both sides. x−3 = 2 y−4 Multiply both sides by x−3and divide by y−4. x = 2 y−4 +3 Add 3 to both sides.

So  f −1 ( y )= 2 y−4 +3 f −1 ( y )= 2 y−4 +3 or  f −1 ( x )= 2 x−4 +3. f −1 ( x )= 2 x−4 +3.

#### Analysis 

The domain and range of  f f exclude the values 3 and 4, respectively.  f f and  f −1 f −1 are equal at two points but are not the same function, as we can see by creating [Table 5](<3-7-inverse-functions#Table_01_07_05>).
...
Now that we can find the inverse of a function, we will explore the graphs of functions and their inverses. Let us return to the quadratic function  f(x)= x 2 f(x)= x 2 restricted to the domain  [0,∞), [0,∞), on which this function is one-to-one, and graph it as in [Figure 7](<3-7-inverse-functions#Figure_01_07_008>).
...
We already know that the inverse of the toolkit quadratic function is the square root function, that is,  f −1 (x)= x . f −1 (x)= x . What happens if we graph both  f f and  f −1 f −1 on the same set of axes, using the  x- x- axis for the input to both  fand  f −1 ? fand  f −1 ?

We notice a distinct relationship: The graph of  f −1 (x) f −1 (x) is the graph of  f(x) f(x) reflected about the diagonal line  y=x, y=x, which we will call the identity line, shown in [Figure 8](<3-7-inverse-functions#Figure_01_07_009>).
...
Given the graph of  f(x) f(x) in [Figure 9](<3-7-inverse-functions#Figure_01_07_010>), sketch a graph of  f −1 (x). f −1 (x).

![Graph of f^\(-1\)\(x\).](/apps/image-cdn/v1/f=webp/apps/archive/20260604.144757/resources/89e55026023617d72b53b384fc09c580c276297f) Figure  9
...
If we reflect this graph over the line  y=x, y=x, the point  ( 1,0 ) ( 1,0 ) reflects to  ( 0,1 ) ( 0,1 ) and the point  ( 4,2 ) ( 4,2 ) reflects to  ( 2,4 ). ( 2,4 ). Sketching the inverse on the same axes as the original graph gives [Figure 10](<3-7-inverse-functions#Figure_01_07_011>).

![Graph of f\(x\) and f^\(-1\)\(x\).](/apps/image-cdn/v1/f=webp/apps/archive/20260604.144757/resources/f0584df6b97e9730ba9fd0db62779f481efb8c9f) Figure  10 The function and its inverse, showing reflection about the identity line

###  Try It  #9

Draw graphs of the functions  f f and  f −1 f −1 from [Example 8](<3-7-inverse-functions#Example_01_07_09>).
...
For the following exercises, use the graph of  f f shown in [Figure 11](<3-7-inverse-functions#Figure_01_07_203>).

![Graph of a line.](/apps/image-cdn/v1/f=webp/apps/archive/20260604.144757/resources/7622ee8a42b041a821d31163f254dd491f83cca5) Figure  11
...
For the following exercises, use the graph of the one-to-one function shown in [Figure 12](<3-7-inverse-functions#Figure_01_07_204>).
...
For the following exercises, use the values listed in [Table 6](<3-7-inverse-functions#eip-151>) to evaluate or solve.
...
Use the tabular representation of  f f in [Table 7](<3-7-inverse-functions#Table_01_07_08>) to create a table for  f −1 ( x ). f −1 ( x ).
