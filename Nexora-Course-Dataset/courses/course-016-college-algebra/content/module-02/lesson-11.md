...
> Official URL: https://openstax.org/books/college-algebra/pages/2-practice-test
> License: CC BY 4.0
...
Find the _x-_ and _y_ -intercepts for the following:  2x−5y=6 2x−5y=6

[3](<chapter-2>). 

Find the _x-_ and _y_ -intercepts of this equation, and sketch the graph of the line using just the intercepts plotted.
...
Solve for _x_ :  5x+8=3x−10. 5x+8=3x−10.
...
Solve for _x_ :  x 2 +1= 4 x x 2 +1= 4 x

[9](<chapter-2>). 

Solve for _x_ :  5 x+4 =4+ 3 x−2 . 5 x+4 =4+ 3 x−2 .
...
Solve for _x_. Write the answer in simplest radical form.
