...
> Official URL: https://www.greenteapress.com/thinkpython/thinkCSpy/html/chap17.html
> License: CC BY
...
| [![Previous](images/prev.png)](<chap16.html>) | [![Up](images/up.png)](<index.html>) | [![Next](images/next.png)](<chap18.html>) | How to Think Like a Computer Scientist | [![Index](images/index.png)](<dex.html>)  
---|---|---|---|---  
...
We have seen examples of attributes that refer to other objects, which we called **embedded references** (see [Section 12.8](<chap12.html#8>)). A common data structure, the **linked list** , takes advantage of this feature. 
