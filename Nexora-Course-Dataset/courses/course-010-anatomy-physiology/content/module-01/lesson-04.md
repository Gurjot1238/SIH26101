...
> Official URL: https://openstax.org/books/anatomy-and-physiology/pages/1-3-functions-of-human-life
> License: CC BY 4.0
...
Taken together, these two processes are called metabolism. Metabolism is the sum of all anabolic and catabolic reactions that take place in the body ([Figure 1.6](<1-3-functions-of-human-life#fig-ch01_03_01>)). Both anabolism and catabolism occur simultaneously and continuously to keep you alive.

![This illustration shows food entering a cell and being broken down into smaller particles of different colors. This is catabolism, which releases energy. In anabolism, the different colored particles are combined with each other to form larger, multi-colored structures. Anabolism requires an energy input.](/apps/image-cdn/v1/f=webp/apps/archive/20260604.144757/resources/b6e9e8662d5988831a15ddcabdd64d42f8f59957) Figure  1.6 Metabolism Anabolic reactions are building reactions, and they consume energy. Catabolic reactions break materials down and release energy. Metabolism includes both anabolic and catabolic reactions.
