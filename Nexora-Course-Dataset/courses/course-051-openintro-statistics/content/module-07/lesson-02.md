...
Friday the 13$^th$, Part I In the 
...
13$^th$ and the previous Friday, Friday the 6$^th$. The 
histograms below show the distribution of number of cars passing by a specific 
intersection on Friday the 6$^th$ and Friday the 13$^th$ for 
many such date pairs. Also given are some sample statistics, where the 
difference is the number of cars on the 6th minus the number of cars on the 13th.
center
ch_inference_for_means/figures/eoce/friday_13th_traffic/friday_13th_traffic_hist \\
$\:$ \\
...
- What are the hypotheses for evaluating whether the number of people out 
on Friday the 6$^th$ is different than the number out on Friday the 
13$^th$?
- Check conditions to carry out the hypothesis test from part~(b).
- Calculate the test statistic and the p-value.
- What is the conclusion of the hypothesis test?
- Interpret the p-value in this context.
- What type of error might have been made in the conclusion of your test? 
Explain.
parts

Diamonds, Part I Prices of diamonds are determined by 
...
distributions and some sample statistics are shown below. \\[1mm]
minipage[c]0.57
...
minipage[c]0.43
center
0.875ch_inference_for_means/figures/eoce/diamonds_1/diamonds_box.pdf
center
minipage

Friday the 13$^th$, Part II
The Friday the $13^th$ study reported in
Exercise~ also provides data on traffic
accident related emergency room admissions.
The distributions of these counts from Friday the 6$^th$ and
Friday the 13$^th$ are shown below for six such paired dates
along with summary statistics.
You may assume that conditions for inference are met.
center
0.9ch_inference_for_means/figures/eoce/friday_13th_accident/friday_13th_accident_hist \\
$\:$ \\
minipage[c]0.32
tabularl c c c
...
parts
- Conduct a hypothesis test to evaluate if there is a difference between 
...
- The conclusion of the original study states, ``Friday 13th is unlucky for 
some. The risk of hospital admission as a result of a transport accident may be 
increased by as much as 52\
with this statement? Explain your reasoning.
parts

Diamonds, Part II In Exercise~, we 
...
[c]0.65
center
ch_inference_for_means/figures/eoce/chick_wts_linseed_horsebean/chick_wts_box.pdf
center
minipage
minipage[c]0.35
l c c c
...
parts
- Describe the distributions of weights of chickens that were fed linseed 
and horsebean.
- Do these data provide strong evidence that the average weights of 
chickens that were fed linseed and horsebean are different? Use a 5\
significance level.
- What type of error might we have committed? Explain.
- Would your conclusion change if we used $ = 0.01$?
parts
...
minipage[c]0.6
center
0.7ch_inference_for_means/figures/eoce/fuel_eff_city/fuel_eff_city_box.pdf
center
minipage

Chicken diet and weight, Part II Casein is 
a common weight gain supplement for humans. Does it have an effect on chickens? 
Using data provided in Exercise~, test the 
...
of the same 52 cars from Exercise~.
Use these statistics to calculate a 98\
...
minipage[c]0.6
center
0.7ch_inference_for_means/figures/eoce/fuel_eff_hway/fuel_eff_hway_box.pdf
center
minipage
...
hypotheses, check conditions, and interpret results in the context of the data.

center
ch_inference_for_means/figures/eoce/prison_isolation_T/prison_isolation_hist \\
$\:$ \\
tabularl  r  r  r  r  
...
True / False: comparing means Determine if the 
following statements are true or false, and explain your reasoning for 
statements you identify as false.
parts
- When comparing means of two samples where $n_1 = 20$ and $n_2 = 40$, we 
can use the normal model for the difference in means since $n_2  30$.
- As the degrees of freedom increases, the $t$-distribution approaches 
normality.
- We use a pooled standard error for calculating the standard error of the 
