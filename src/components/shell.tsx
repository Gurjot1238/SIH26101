...
import { Bell, BookOpen, Building2, ChevronDown, ClipboardCheck, Compass, FileText, LayoutDashboard, Menu, Network, Presentation, Sparkles, UserRound, X } from 'lucide-react';
