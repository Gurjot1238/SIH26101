...
> Official URL: https://www.greenteapress.com/thinkpython/thinkCSpy/html/chap20.html
> License: CC BY
...
| [![Previous](images/prev.png)](<chap19.html>) | [![Up](images/up.png)](<index.html>) | [![Next](images/next.png)](<app01.html>) | How to Think Like a Computer Scientist | [![Index](images/index.png)](<dex.html>)  
---|---|---|---|---  
...
13`. We treat this expression as a product of products, namely `3   
* (5 * 13)`. The resulting tree is: 

![](illustrations/tree4.png)
