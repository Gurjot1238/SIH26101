...
> Official URL: https://www.py4e.com/html3/02-variables
> License: CC BY 4.0
...
We call these wisely chosen variable names “mnemonic variable names”. The word _mnemonic_ 2 means “memory aid”. We choose mnemonic variable names to help us remember why we created the variable in the first place.
...
* * *
  ...
  1. In Python 2, this function was named `raw_input`.↩︎

  2. See <https://en.wikipedia.org/wiki/Mnemonic> for an extended description of the word “mnemonic”.↩︎
