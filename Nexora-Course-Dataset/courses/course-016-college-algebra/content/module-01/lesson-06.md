...
> Official URL: https://openstax.org/books/college-algebra/pages/1-6-rational-expressions
> License: CC BY 4.0
...
(x+3)(x−3) (x+3)(x+1) Factor the numerator and the denominator. x−3 x+1 Cancel common factor (x+3). (x+3)(x−3) (x+3)(x+1) Factor the numerator and the denominator. x−3 x+1 Cancel common factor (x+3).
...
**Can the x 2 x 2 term be cancelled in [Example 1](<1-6-rational-expressions#Example_01_06_01>)?**

_No. A factor is an expression that is multiplied by another expression. The x 2 x 2 term is not a factor of the numerator or the denominator._

###  Try It  #1

Simplify  x−6 x 2 −36 . x−6 x 2 −36 .
...
x2+4x−5 3x+18 ⋅ 2x−1 x+5 x2+4x−5 3x+18 ⋅ 2x−1 x+5

####  Solution

(x+5)(x−1) 3(x+6) ⋅ (2x−1) (x+5) Factor the numerator and denominator. (x+5)(x−1)(2x−1) 3(x+6)(x+5) Multiply numerators and denominators. (x+5) (x−1)(2x−1) 3(x+6) (x+5) Cancel common factors to simplify. (x−1)(2x−1) 3(x+6) (x+5)(x−1) 3(x+6) ⋅ (2x−1) (x+5) Factor the numerator and denominator. (x+5)(x−1)(2x−1) 3(x+6)(x+5) Multiply numerators and denominators. (x+5) (x−1)(2x−1) 3(x+6) (x+5) Cancel common factors to simplify. (x−1)(2x−1) 3(x+6)
...
2 x 2 +x−6 x 2 −1 ÷ x 2 −4 x 2 +2x+1 2 x 2 +x−6 x 2 −1 ÷ x 2 −4 x 2 +2x+1

####  Solution

2x2+x−6x2−1 ⋅ x2+2x+1x2−4 Rewrite as multiplication. (2x−3)(x+2) (x+1)(x−1) ⋅ (x+1)2 (x+2)(x−2) Factor. (2x−3) (x+2)(x+1)2 (x+1) (x−1) (x+2) (x−2) Multiply. (2x−3)(x+1) (x−1)(x−2) Cancel common factors to simplify. 2x2+x−6x2−1 ⋅ x2+2x+1x2−4 Rewrite as multiplication. (2x−3)(x+2) (x+1)(x−1) ⋅ (x+1)2 (x+2)(x−2) Factor. (2x−3) (x+2)(x+1)2 (x+1) (x−1) (x+2) (x−2) Multiply. (2x−3)(x+1) (x−1)(x−2) Cancel common factors to simplify.

###  Try It  #3

Divide the rational expressions and express the quotient in simplest form:

9 x 2 −16 3 x 2 +17x−28 ÷ 3 x 2 −2x−8 x 2 +5x−14 9 x 2 −16 3 x 2 +17x−28 ÷ 3 x 2 −2x−8 x 2 +5x−14
...
First, we have to find the LCD. In this case, the LCD will be  xy. xy. We then multiply each expression by the appropriate form of 1 to obtain  xy xy as the denominator for each fraction.

5 x ⋅ y y + 6 y ⋅ x x 5y xy + 6x xy 5 x ⋅ y y + 6 y ⋅ x x 5y xy + 6x xy
...
6 (x+2) 2 − 2 (x+2)(x−2) Factor. 6 (x+2) 2 ⋅ x−2 x−2 − 2 (x+2)(x−2) ⋅ x+2 x+2 Multiply each fraction to get LCD as denominator. 6(x−2) (x+2) 2 (x−2) − 2(x+2) (x+2) 2 (x−2) Multiply. 6x−12−(2x+4) (x+2) 2 (x−2) Apply distributive property. 4x−16 (x+2) 2 (x−2) Subtract. 4(x−4) (x+2) 2 (x−2) Simplify. 6 (x+2) 2 − 2 (x+2)(x−2) Factor. 6 (x+2) 2 ⋅ x−2 x−2 − 2 (x+2)(x−2) ⋅ x+2 x+2 Multiply each fraction to get LCD as denominator. 6(x−2) (x+2) 2 (x−2) − 2(x+2) (x+2) 2 (x−2) Multiply. 6x−12−(2x+4) (x+2) 2 (x−2) Apply distributive property. 4x−16 (x+2) 2 (x−2) Subtract. 4(x−4) (x+2) 2 (x−2) Simplify.

###  Q&A

**Do we have to use the LCD to add or subtract rational expressions?**

_No. Any common denominator will work, but it is easiest to use the LCD._
...
y⋅ x x + 1 x Multiply by  x x to get LCD as denominator. xy x + 1 x xy+1 x Add numerators. y⋅ x x + 1 x Multiply by  x x to get LCD as denominator. xy x + 1 x xy+1 x Add numerators.

Now the numerator is a single rational expression and the denominator is a single rational expression.

xy+1 x x y xy+1 x x y

We can rewrite this as division, and then multiplication.

xy+1 x ÷ x y xy+1 x ⋅ y x Rewrite as multiplication. y(xy+1) x 2 Multiply. xy+1 x ÷ x y xy+1 x ⋅ y x Rewrite as multiplication. y(xy+1) x 2 Multiply.
...
_Yes. We can always rewrite a complex rational expression as a simplified rational expression._
...
![A rectangle that’s labeled: Area = fifteen times x squared minus eight times x minus seven.](/apps/image-cdn/v1/f=webp/apps/archive/20260604.144757/resources/9ac3d25e42f050ee41be9bd7cd20390b0f0e0911)
